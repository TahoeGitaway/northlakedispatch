...
def carpet_log():
    ...
    cur  = get_cursor(conn)
    cur.execute("""
        SELECT cl.id, cl.log_date, cl.cleaner_name, cl.notes, cl.created_at,
...
def carpet_log_add():
    ...
    cur  = get_cursor(conn)
    cur.execute("""
        INSERT INTO carpet_log (log_date, cleaner_name, notes, logged_by, created_at)
        VALUES (%s, %s, %s, %s, %s) RETURNING id
    """, (log_date, cleaner_name, notes or None,
